...
using WolfBlog.API.Contracts;
using WolfBlog.API.Contracts.Services;
using WolfBlog.API.Contracts.Services.IServices;
using WolfBlog.API.Data;
...
namespace WolfBlog.API
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                var filepath = Path.Combine(AppContext.BaseDirectory, "WolfBlog.API.xml");
